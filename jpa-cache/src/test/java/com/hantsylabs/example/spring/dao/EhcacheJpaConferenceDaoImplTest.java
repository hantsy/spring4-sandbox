...
@ContextConfiguration(locations = "classpath:/com/hantsylabs/example/spring/config/applicationContext-jpa-ehcache.xml")
public class EhcacheJpaConferenceDaoImplTest {

	private static final Logger log = LoggerFactory
			.getLogger(EhcacheJpaConferenceDaoImplTest.class);
