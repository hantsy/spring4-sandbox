...
public class GroovyJpaConferenceDaoImplTest {
	...
	public static void initTestClass() {
		...
		// "classpath:/com/hantsylabs/example/spring/config/JpaConfigGroovy.groovy");
		// conferenceDao = ctx.getBean(GroovyJpaConferenceDaoImpl.class);
		// entityManager = ctx
		// .getBean(LocalContainerEntityManagerFactoryBean.class)
		// .getObject().createEntityManager();
		// transactionManager = ctx.getBean(JpaTransactionManager.class);
		// transacationTemplate = new TransactionTemplate(transactionManager);
	}
