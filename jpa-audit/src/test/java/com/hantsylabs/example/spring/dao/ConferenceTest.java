...
public class ConferenceTest {
	...
	public void retrieveConference() {
		...
		assertTrue(conference.getModifiedBy() != null);

		assertTrue("hantsy"
				.equals(conference.getModifiedBy().getUsername()));
		assertTrue(conference.getModifiedDate() != null);

		assertTrue(conference.getCreatedDate().equals(
				conference.getModifiedDate()));
		...
		log.debug("modified date @" + conference.getModifiedDate());
		assertTrue(!conference.getCreatedDate().equals(
				conference.getModifiedDate()));
	}
